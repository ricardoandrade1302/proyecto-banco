...
public class Retirar extends JFrame implements ActionListener, KeyListener {
    ...
    public Retirar(Main main) {
        ...
        labelHead = new JLabel("ZONA TRANSACCIONAL: RETIRO");
        labelHead.setBounds(90, 5, 350, 40);
        labelHead.setFont(new Font("Andale Mono", 3, 18));
        add(labelHead);

        ImageIcon imagen = new ImageIcon("images/retirar.png");
        labelLogo = new JLabel(imagen);
        labelLogo.setBounds(25, 15, 210, 213);
        add(labelLogo);

        labelIngresar = new JLabel("Ingrese Monto a Retirar $");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnConfirmar) {
            ...
            if (monto.equals("")) {
                ...
                if (retiro > Main.saldoActual) {
                    JOptionPane.showMessageDialog(null, "Saldo insuficiente.");
                } else {
                    Main.saldoActual -= retiro;
                    JOptionPane.showMessageDialog(null, "Retiro exitoso. Nuevo saldo: $" + Main.saldoActual);
